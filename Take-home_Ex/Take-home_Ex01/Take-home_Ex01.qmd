...
g <- ggplot(data = p,
       aes(x = fct_inorder(educationLevel))) +
  geom_bar(color="black", fill="light blue") +
...
The above findings are consistent with the Hypothetical Outcomes Plots shown below that shows the monthly income range of 100 random samples.
